...
//   console.log(lessons)
 ...
 console.log(course)
//  console.log(course?.lesson[0]?.name) 
 ...
 const handletestquestionchange=(e,number,questionnumber)=>{
   ...
   newpage[questionnumber].question = e
 ...
 const handletestanswerchange=(e,number,questionnumber)=>{
  const newlesson=[...lessons]
  const newpage=[...newlesson[number].test]
  newpage[questionnumber].answer = e
  newlesson[number].test=newpage
  setlessons(newlesson)
} 
...
useEffect(()=>{
 ...
 useEffect(()=>{
...

  {
    ...
    editlessonname={course?.lesson[0]?.name}
    editslidecontent={course?.lesson[0]?.slides[0]?.content}
    editslidetitle={course?.lesson[0]?.slides[0].title}
...

{
    ...
    <Coursecreateslide2 
      ...
      editslidecontent={course?.lesson[0]?.slides[1]?.content}
      editslidetitle={course?.lesson[0]?.slides[1].title}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={0}
      maxcount={maxcount}
    ...
    editslidecontent={course?.lesson[0]?.slides[2]?.content}
    editslidetitle={course?.lesson[0]?.slides[2].title}
    setslidecontent={handleslidecontentchange}
    setslidetitle={handleslidetitlechange}
    lessonnumber={0}
    maxcount={maxcount}
...

{
    ...
    <Coursecreateslide2 
      ...
      editslidecontent={course?.lesson[0]?.slides[3]?.content}
      editslidetitle={course?.lesson[0]?.slides[3].title}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={0}
      maxcount={maxcount}
    ...
    <Coursecreateslide2  
     ...
     editslidecontent={course?.lesson[0]?.slides[4]?.content}
     editslidetitle={course?.lesson[0]?.slides[4].title}
     setslidecontent={handleslidecontentchange}
     setslidetitle={handleslidetitlechange}
     lessonnumber={0}
     maxcount={maxcount}
...

{
    ...
    setlessonname={handlechangename}
    editlessonname={course?.lesson[1]?.name}
    editslidecontent={course?.lesson[1]?.slides[0]?.content}
    editslidetitle={course?.lesson[1]?.slides[0].title}
...

{
    ...
    <Coursecreateslide2 
          ...
          editslidecontent={course?.lesson[1]?.slides[1]?.content}
          editslidetitle={course?.lesson[1]?.slides[1].title}
          setslidecontent={handleslidecontentchange}
          setslidetitle={handleslidetitlechange}
          lessonnumber={1}
          maxcount={maxcount}
    ...
    <Coursecreateslide2 
          ...
          editslidecontent={course?.lesson[1]?.slides[2]?.content}
          editslidetitle={course?.lesson[1]?.slides[2].title}
          setslidecontent={handleslidecontentchange}
          setslidetitle={handleslidetitlechange}
          lessonnumber={1}
          maxcount={maxcount}
...

{
    ...
    <Coursecreateslide2 
      ...
      editslidecontent={course?.lesson[1]?.slides[3]?.content}
      editslidetitle={course?.lesson[1]?.slides[3].title}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={1}
      maxcount={maxcount}
    ...
    <Coursecreateslide2  
     ...
     editslidecontent={course?.lesson[1]?.slides[4]?.content}
     editslidetitle={course?.lesson[1]?.slides[4].title}
     setslidecontent={handleslidecontentchange}
     setslidetitle={handleslidetitlechange}
     lessonnumber={1}
     maxcount={maxcount}
...

{
    ...
    editlessonname={course?.lesson[2]?.name}
    editslidecontent={course?.lesson[2]?.slides[0]?.content}
    editslidetitle={course?.lesson[2]?.slides[0].title}
    setslidecontent={handleslidecontentchange}
    setslidetitle={handleslidetitlechange}
    lessonnumber={2}
    slidenumber={0}
...

{
   ...
   <Coursecreateslide2 
      ...
      editslidecontent={course?.lesson[2]?.slides[1]?.content}
      editslidetitle={course?.lesson[2]?.slides[1].title}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={2}
      maxcount={maxcount}
    ...
    editslidecontent={course?.lesson[2]?.slides[2]?.content}
    editslidetitle={course?.lesson[2]?.slides[2].title}
    setslidecontent={handleslidecontentchange}
    setslidetitle={handleslidetitlechange}
    lessonnumber={2}
    maxcount={maxcount}
...

{
    ...
    >
     <Coursecreateslide2 
      ...
      editslidecontent={course?.lesson[2]?.slides[3]?.content}
      editslidetitle={course?.lesson[2]?.slides[3].title}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={2}
      maxcount={maxcount}
...

{
    ...
    editlessonname={course?.lesson[3]?.name}
    editslidecontent={course?.lesson[3]?.slides[0]?.content}
    editslidetitle={course?.lesson[3]?.slides[0].title}
    setslidecontent={handleslidecontentchange}
    setslidetitle={handleslidetitlechange}
    lessonnumber={3}
    slidenumber={0}
...

{
   ...
   <Coursecreateslide2 
      ...
      editslidecontent={course?.lesson[3]?.slides[1]?.content}
    editslidetitle={course?.lesson[3]?.slides[1].title}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={3}
      maxcount={maxcount}
    ...
    editslidecontent={course?.lesson[3]?.slides[2]?.content}
    editslidetitle={course?.lesson[3]?.slides[2].title}
    setslidecontent={handleslidecontentchange}
    setslidetitle={handleslidetitlechange}
    lessonnumber={3}
    maxcount={maxcount}
...

{
    ...
    <Coursecreateslide2 
      ...
      editslidecontent={course?.lesson[3]?.slides[3]?.content}
    editslidetitle={course?.lesson[3]?.slides[3].title}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={3}
      maxcount={maxcount}
...

{
    ...
    editlessonname={course?.lesson[4]?.name}
    editslidetitle={course?.lesson[4]?.slides[0]?.title}
    editslidecontent={course?.lesson[4]?.slides[0]?.content}
    setslidecontent={handleslidecontentchange}
    setslidetitle={handleslidetitlechange}
    lessonnumber={4}
    slidenumber={0}
...

{
    ...
    >
     <Coursecreateslide2 
      ...
      editslidetitle={course?.lesson[4]?.slides[1]?.title}
      editslidecontent={course?.lesson[4]?.slides[1]?.content}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={4}
      maxcount={maxcount}
    ...
    editslidetitle={course?.lesson[4]?.slides[2]?.title}
    editslidecontent={course?.lesson[4]?.slides[2]?.content}
    setslidecontent={handleslidecontentchange}
    setslidetitle={handleslidetitlechange}
    lessonnumber={4}
    maxcount={maxcount}
...

{
  ...
  <Coursecreateslide2 
      ...
      editslidetitle={course?.lesson[4]?.slides[3]?.title}
      editslidecontent={course?.lesson[4]?.slides[3]?.content}
      setslidecontent={handleslidecontentchange}
      setslidetitle={handleslidetitlechange}
      lessonnumber={4}
      maxcount={maxcount}
    ...
    <Coursecreateslide2  
     ...
     editslidetitle={course?.lesson[4]?.slides[4]?.title}
     editslidecontent={course?.lesson[4]?.slides[4]?.content}
     setslidecontent={handleslidecontentchange}
     setslidetitle={handleslidetitlechange}
     lessonnumber={4}
     maxcount={maxcount}
