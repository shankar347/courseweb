...
const Collegewiseleaderboard = () => {
  ...
  const {collegetoppers:studenttoppers} =useContext(skillcontext)
 
  console.log(studenttoppers)
...
>
     ...
     />
      ...
      fontWeight={'550'}
      >
         {studenttoppers && studenttoppers?.length >1  && 
        studenttoppers[1].name}
      </Flex>
     </Flex>
     <Flex flexDir={'column'}
     alignItems={'center'}
     ...
     />
      ...
      mt={'5'}
      >
        {studenttoppers && studenttoppers?.length >0  && 
        studenttoppers[0].name}
      </Flex>
     </Flex>
     <Flex flexDir={'column'}
     alignItems={'center'}
...
width={'150px'}
     ...
     />
      ...
      fontWeight={'550'}
      >
                {studenttoppers && studenttoppers?.length >2  && 
        studenttoppers[2].name}
      </Flex>
    </Flex>
    </Flex>
     <Flex 
